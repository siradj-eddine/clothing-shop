      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col space-y-3">
            ...
            <Link href="/customer-service" className="text-sm text-gray-600 hover:text-blue-600 transition-colors">
              {t('footer.customerService')}
            </Link>
            <Link href="/shipping-returns" className="text-sm text-gray-600 hover:text-blue-600 transition-colors">
          ...
          <div className="flex flex-col space-y-3">
            ...
            <Link href="/size-guide" className="text-sm text-gray-600 hover:text-blue-600 transition-colors">
              {t('footer.sizeGuide')}
            </Link>
          </div>
