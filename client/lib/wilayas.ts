...
export const wilayas: Wilaya[] = [
  ...
  { id: 34, name: "Bordj Bou Arréridj", arabic_name: "برج بوعريريج", shipping_cost: 500, code: "34" },
  ...
  { id: 50, name: "Bordj Badji Mokhtar", arabic_name: "برج باجي مختار", shipping_cost: 1500, code: "50" },
